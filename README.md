...
📌 Objective
The objective of this project is to analyze the annual sales data of Vrinda Store to understand customer behavior, identify geographical sales distribution, and track monthly revenue trends for data-driven decision making.
...
**📊 Key Metrics**
Total Sales: ~$21M (Calculated)
Top Sales Month: March ($1.93M)
Dominant Gender: Women (64%)
Top Age Group: Adult (48%)
Highest Revenue State: Maharashtra ($2.99M)
